...
class Converter:
    ...
    def __init__(self):
        ...
        # Five item list
        # self.all_calculations = ['O F° is -18 C°', 'O C° is 32 F°',
...
class HistoryExport:
    ...
    def __init__(self, partner, calc_list):
        ...
        save_text = "Either choose a custom file name (and push " \
                    "<Export>) or simply push <Export> to sve your " \
    ...
    # retrieves date and create YYYY_MM_DD string
    def get_date(self):
        today = date.today()
    ...
    def check_filename(filename):
        ...
        # iterates through filename and check each letter.
